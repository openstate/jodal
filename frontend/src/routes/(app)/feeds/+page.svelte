...
<div class="lg:max-w-300 px-6 py-8 lg:mx-auto">
  <h1 class="mb-6 text-2xl font-display font-medium">Jouw feeds</h1>
  <p class="text-stone-700 text-lg mb-10">Met feeds blijf je altijd op de hoogte van de nieuwste overheidsdocumenten in jouw onderzoeksgebied.</p>
